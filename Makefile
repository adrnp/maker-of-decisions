...
mod: mod.o serial_port.o read_thread.o commander.o serialwifly.o test.o wifly_thread.o bearing_cc.o bearing_helper.o bearing_mle.o
	g++ mod.o serial_port.o read_thread.o commander.o serialwifly.o test.o wifly_thread.o bearing_cc.o bearing_helper.o bearing_mle.o -o mod -pthread

mod.o: mod.h mod.cpp serial_port.h read_thread.h serialwifly.h test.h wifly_thread.h mav_struct.h common.h bearing.h
